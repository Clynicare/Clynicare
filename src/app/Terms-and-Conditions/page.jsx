...
export default function Page() {
  ...
  useEffect(() => {
    // Enable smooth scroll on page load
    document.documentElement.style.scrollBehavior = 'smooth';

    // Cleanup when component unmounts to revert back to default behavior
    return () => {
      ...
      <div className="Terms-and-Conditions min-h-screen w-full">
        <div className="relative">
          <img
            ...
            loading="lazy" // Lazy loading for the image to improve performance
          />
          <h1
        ...
        <div className="start w-full px-6 md:px-[100px] py-10">
          ...
          <div className="T&C flex flex-col md:flex-row mt-10 gap-6">
            ...
            <div className="leftSide w-full md:w-1/4 flex flex-col gap-3 text-sm md:text-base px-3 md:px-5">
              <p className="bg-gradient-to-b from-[#4DA1A9] to-[#007BA7] text-transparent bg-clip-text">
                Introduction
              </p>
