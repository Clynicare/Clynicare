...
function InfiniteScroll({ direction = 'left' }) {
  const images = [
    ...
    "https://images.unsplash.com/photo-1583324113626-70df0f4deaab?auto=format&fit=crop&q=70&w=400",
    "https://images.unsplash.com/photo-1666214280557-f1b5022eb634?auto=format&fit=crop&q=70&w=400",
  ];
