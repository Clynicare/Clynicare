    ...
    <div className='footer w-full px-6 md:px-[100px] py-10'>
      ...
      <div className="main flex flex-col md:flex-row justify-between mt-8 space-y-8 md:space-y-0">
        ...
        <div className="links flex flex-col md:flex-row gap-10">
          ...
          <div className="flex flex-col gap-3">
            ...
            <Link href="/appointment" className='text-sm text-black/50 hover:text-[#007BA7] transition-colors'>Book Appointment</Link>
            <Link href="/intake-form" className='text-sm text-black/50 hover:text-[#007BA7] transition-colors'>Intake Form</Link>
          </div>

          {/* Second Column */}
          <div className="flex flex-col gap-3">
            <p className='bg-gradient-to-b from-[#4DA1A9] to-[#007BA7] text-transparent bg-clip-text font-semibold'>Help Center</p>
            <Link href="/About" className='text-sm text-black/50 hover:text-[#007BA7] transition-colors'>About Us</Link>
            <Link href="/contact" className='text-sm text-black/50 hover:text-[#007BA7] transition-colors'>Contact Us</Link>
            <Link href="/pricing" className='text-sm text-black/50 hover:text-[#007BA7] transition-colors'>Pricing</Link>
          </div>
        </div>
        ...
        <div className="download flex flex-col gap-3">
          ...
          <div className="flex gap-3">
            <Link href="/app-store">
              <div className="flex items-center gap-2 border-2 border-black rounded-lg px-3 py-2 hover:scale-105 transition-transform">
      ...
      <div className="flex flex-col md:flex-row justify-between items-center text-sm text-black/50 text-center md:text-left space-y-4 md:space-y-0">
        ...
        <p>
          ...
          <Link href="/about" className='bg-gradient-to-b from-[#4DA1A9] to-[#007BA7] text-transparent bg-clip-text font-semibold ml-1'>
            ONEDUMB TEAM
          </Link>
        </p>
        ...
        <div className="flex gap-4">
          <Link href="/Terms-and-Conditions" className='text-sm text-black/50 hover:text-[#007BA7] transition-colors'>
            Terms & Conditions
          </Link>
          <Link href="/Privacy-Policy" className='text-sm text-black/50 hover:text-[#007BA7] transition-colors'>
            Privacy Policy
          </Link>
        </div>
      </div>
