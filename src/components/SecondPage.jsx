...
export default function SecondPage(){
    ...
    return(
        <div className="h-[150vh] px-[180px] py-[200px] flex gap-[70px] font-rejoice">
           ...
           <div className="rightpart ">
            ...
            <p className="font-medium text-xl text-gray-600 border-b-2 pb-4">With our user-friendly platform,accessing top notch nursing care has never been easier.</p>
            </div>
            <div className="steps ">
